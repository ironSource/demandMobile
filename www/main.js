...
/*!*******************************!*\
  !*** ./src/app/app-config.ts ***!
  \*******************************/
/*! exports provided: appPages */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "appPages", function() { return appPages; });
var appPages = [
    {
        title: 'Platform',
    ...
    },
    {
        ...
        url: '/entrace/notifications',
        icon: 'notifications-outline'
    },
    {
        title: 'Back office',
        url: '/entrace/back-office',
        icon: 'stats'
    },
    {
        title: 'Login As',
        url: '/entrace/login-as',
        icon: 'contact'
    }
];
...
function init_app(authService) {
    return function () { return authService.getToken(); };
}
...
var AuthService = /** @class */ (function () {
    function AuthService(storage, http, splashScreen) {
        ...
        this.http = http;
        this.splashScreen = splashScreen;
        this.userStateSubject$ = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"](true);
        this.userStateChanged$ = this.userStateSubject$.asObservable();
    }
    ...
    AuthService.prototype.loginAs = function () {
...
var environment = {
    production: false,
    host: 'https://dev-php-demand1.supersonicads.com'
};
/*
...
module.exports = __webpack_require__(/*! /Users/chen.levin/Desktop/projects/demandMobile/src/main.ts */"./src/main.ts");
